...
sleepy_state_e sleepy_time_init(sleepy_params_t* pt_sleepy_params){
    ...
    // alarm needs to be passsed pointer to last button press time
...
int64_t sleepy_time_callback(alarm_id_t id, void *user_data){
    ...
    sleepy_params_t* pt_sleepy_params = (sleepy_params_t*) user_data;

    pt_sleepy_params->is_sleepy_time = true;
